            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="Fina" width="32px" height="32px" />
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                            ...
                            onClick={() => {
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                ...
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added XFNA to MetaMask')
                                    } else {
                    ...
                    {chainId && chainId in FNA_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add FNA to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added FNA to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
              ...
              <div className="flex flex-col px-4 pt-2 pb-3 space-y-1">
                ...
                {chainId && featureEnabled(Feature.ANALYTICS, chainId) && (
                  <ExternalLink
                    ...
                    href={ANALYTICS_URL[chainId] || 'https://analytics.finaswap.com'}
                    className="p-2 text-baseline text-primary hover:text-high-emphesis focus:text-high-emphesis md:p-3 whitespace-nowrap"
                  >
                    {i18n._(t`Analytics`)}
                  </ExternalLink>
