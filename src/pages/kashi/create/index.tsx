import { CHAINLINK_ORACLE_ADDRESS, Currency, KASHI_ADDRESS } from '@finaswap/sdk'
...
function Create() {
  ...
  return (
    <>
      <Head>
        <title>Create Lending Pair | Kashi by Fina</title>
        <meta key="description" name="description" content="Create Lending Pair on Kashi by Fina" />
      </Head>
      <Card
