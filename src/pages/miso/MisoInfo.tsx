    ...
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-12 mt-6 divide-x divide-white divide-opacity-50">
        ...
        <div className="flex flex-col col-span-4">
          <div className="mx-auto">
            ...
            <div className="text-base font-bold text-white md:text-xl">{`${minRaised} $FNA`}</div>
      ...
      <div className="flex flex-row mt-6">
        ...
        <div className="ml-5 cursor-pointer md:ml-8">
          <a
            href="https://miso.finaswap.com/auctions/0x15c5E87Ce788F0dEBcAF70cF1dde69E3Bc3E6Ad1"
            target="_blank"
      ...
      <div className="flex flex-col mt-6">
        <div>About</div>
        <div>
          The Trident NFT is introduced as a celebratory piece for the announcement and upcoming release of Fina’s
