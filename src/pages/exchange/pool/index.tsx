import { ChainId, CurrencyAmount, JSBI, NATIVE, Pair } from '@finaswap/sdk'
...
import { Currency } from '@finaswap/sdk'
...
export default function Pool() {
  ...
  return (
    <Container id="pool-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Pool | Fina</title>
        <meta
          key="description"
          name="description"
          content="FinaSwap liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
          ...
          {!account ? (
            ...
            <>
              {/* <div className="flex items-center justify-center">
                  <ExternalLink
                    href={"https://analytics.finaswap.com/user/" + account}
                  >
