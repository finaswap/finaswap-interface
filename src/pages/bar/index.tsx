    ...
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Stake FINA in return for xFINA, an interest bearing and fungible ERC20 token designed to share revenue generated by all FINA products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.sushi.com/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE FINA" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE FINA" />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as FINA
                                proportional to your share of the SushiBar. When your FINA is staked into the SushiBar, you recieve
            ...
            {/* <div className="flex">
                            ...
                            <div>
                                <StyledLink className="text-sm text-lg whitespace-nowrap md:text-lg md:leading-5">
                                    Tips for using xFINA
                                </StyledLink>
                            </div>
                        </div> */}
          </div>
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/xsushi-sign.png" alt="xFINA sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}FINA`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">FINA</p>
                    </div>
                  </div>
                </div>
